...
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/forestgeo/fgeo.base?branch=master&svg=true)](https://ci.appveyor.com/project/forestgeo/fgeo.base)
